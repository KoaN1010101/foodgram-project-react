    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=200, unique=True, verbose_name='Имя')),
                ('last_name', models.CharField(max_length=200, unique=True, verbose_name='Фамилия')),
                ('password', models.CharField(max_length=200, unique=True, verbose_name='Пароль')),
